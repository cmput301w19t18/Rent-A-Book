...
public class OldInboxAdapter extends RecyclerView.Adapter<OldInboxAdapter.InboxViewHolder> {
     ...
     */
    public OldInboxAdapter(ArrayList<Book> InboxBookList) {
    ...
    public InboxViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        OldInboxAdapter.InboxViewHolder ivh = new OldInboxAdapter.InboxViewHolder(v);
        return ivh;
    }
